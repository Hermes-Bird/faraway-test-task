...
var data = []string{
	...
	"Aahh... this is what I've been missing. Who knew floating on a piece of driftwood for three weeks, with no food or water, and sea vultures waiting to pluck out your liver, could make one SO tense!",
